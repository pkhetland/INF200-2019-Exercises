...
def multiple_games(num_games,num_players):
    players_positions=[None]*num_games; players_steps=[None]*num_games
...
if __name__ == '__main__':
    seed_passed,players_positions,players_steps = \
                            multi_game_experiment(100,4,randint(1,999))  #27 ) 
#    print("The seed is ", seed_passed)
#    print(p)
    print("The shortest game duration is ", min(players_steps)
                            ," and Longest ", max(players_steps))
    print("The median game duration is ", st.median(players_steps))
    print("The mean game duration is ", st.mean(players_steps))
